...
enum TabItem {
  ...
  localLife(Icons.holiday_village_outlined, '동네생활', LocalLifeFrame()),
  nearMe(Icons.pin_drop_outlined, '내 근처', NearMeFrame()),
  chat(Icons.chat_bubble_outline, '채팅', ChatFrame()),
  my(Icons.person_outline_outlined, '나의 당근', MyFrame());
